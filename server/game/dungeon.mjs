...
export const MONSTERS = {
  // dex/vision/mp（F-25/F-26/F-29）：dex=5E官方属性敏捷；vision=视野半径（格，BOSS按无限处理）；
  // mp=蓝条资源（仅施法者，供F-26蓝条展示）。数值均取自LMoP官方怪物数据，不随意编造。
  goblin: { key: 'goblin', name: '哥布林', icon: '👺', ac: 15, hp: 7, speed: 6, xp: 50, gold: '1d8+3', size: 1, dex: 14, vision: 6,
    attacks: [{ id: 'scimitar', name: '短弯刀', bonus: 4, dmg: '1d6+2', range: 1 }, { id: 'bow', name: '短弓', bonus: 4, dmg: '1d6+2', range: 12 }],
    desc: '绿皮小恶棍，成群结队，欺软怕硬。' },
  wolf: { key: 'wolf', name: '饿狼', icon: '🐺', ac: 13, hp: 11, speed: 7, xp: 50, gold: 0, size: 1, dex: 15, vision: 8,
    attacks: [{ id: 'bite', name: '啮咬', bonus: 4, dmg: '2d4+2', range: 1, onHit: { save: 'STR', dc: 11, effect: '击倒' } }],
    desc: '克拉格养的凶狼，牙尖爪利。' },
  klarg: { key: 'klarg', name: '克拉格', icon: '👹', ac: 15, hp: 22, speed: 6, xp: 200, gold: '2d10+10', size: 1, boss: true, dex: 14, vision: 10,
    attacks: [{ id: 'morningstar', name: '晨星锤', bonus: 4, dmg: '2d8+2', range: 1 }],
    desc: '克拉格莫洞穴的熊地精头目，洞穴的主人。' },
  ruffian: { key: 'ruffian', name: '红标帮打手', icon: '🥷', ac: 14, hp: 16, speed: 6, xp: 100, gold: '1d10+5', size: 1, dex: 12, vision: 6,
  ...
  glasstaff: { key: 'glasstaff', name: '格拉斯塔夫', icon: '🧙‍♂️', ac: 12, hp: 22, speed: 6, xp: 300, gold: '3d10+15', size: 1, boss: true, dex: 14, vision: 7, mp: 20,
  ...
  hobgoblin: { key: 'hobgoblin', name: '霍布哥布林', icon: '🪖', ac: 18, hp: 11, speed: 6, xp: 100, gold: '1d10+8', size: 1, dex: 12, vision: 6,
    attacks: [{ id: 'longsword', name: '长剑', bonus: 3, dmg: '1d8+1', range: 1 }],
    desc: '纪律严明的哥布林近亲，身披鳞甲。' },
  bugbear: { key: 'bugbear', name: '熊地精', icon: '🐻', ac: 16, hp: 24, speed: 6, xp: 200, gold: '2d10+10', size: 1, dex: 14, vision: 6,
    attacks: [{ id: 'morningstar', name: '晨星锤', bonus: 4, dmg: '2d8+2', range: 2 }],
    desc: '毛茸茸的大块头，臂展惊人。' },
  grol: { key: 'grol', name: '王·戈洛尔', icon: '👑', ac: 16, hp: 28, speed: 6, xp: 350, gold: '4d10+20', size: 1, boss: true, dex: 14, vision: 10,
    attacks: [{ id: 'greatclub', name: '巨棒', bonus: 5, dmg: '2d8+3', range: 1 }],
    desc: '克拉格莫城堡的熊地精之王，冈德伦的看守者。' },
  doppelganger: { key: 'doppelganger', name: '变形怪', icon: '🎭', ac: 14, hp: 20, speed: 6, xp: 250, gold: '2d10+10', size: 1, dex: 18, vision: 7,
    attacks: [{ id: 'slam', name: '猛击', bonus: 5, dmg: '2d6+3', range: 1 }],
    desc: '能变作他人模样的诡诈生物，戈洛尔的座上宾。' },
  skeleton: { key: 'skeleton', name: '骷髅兵', icon: '💀', ac: 13, hp: 13, speed: 6, xp: 75, gold: 0, size: 1, undead: true, dex: 14, vision: 6,
    attacks: [{ id: 'sbow', name: '短弓', bonus: 4, dmg: '1d6+2', range: 10 }, { id: 'ssword', name: '短剑', bonus: 4, dmg: '1d6+2', range: 1 }],
    desc: '百年前矿难矿工的遗骸，仍守护着洞穴。' },
  zombie: { key: 'zombie', name: '僵尸', icon: '🧟', ac: 8, hp: 18, speed: 4, xp: 75, gold: 0, size: 1, undead: true, dex: 6, vision: 4,
    attacks: [{ id: 'slam', name: '猛击', bonus: 3, dmg: '1d6+1', range: 1 }],
    desc: '蹒跚的亡者，生命力顽强得诡异。' },
  giantspider: { key: 'giantspider', name: '巨蜘蛛', icon: '🕷️', ac: 14, hp: 20, speed: 6, xp: 200, gold: 0, size: 1, dex: 16, vision: 8,
    attacks: [{ id: 'bite', name: '毒牙', bonus: 5, dmg: '1d8+3', range: 1, poison: { save: 'CON', dc: 11, dmg: '2d6', type: '毒素' } }],
    desc: '回声波洞穴的原住民，涅兹纳尔的宠物。' },
  nezznar: { key: 'nezznar', name: '涅兹纳尔', icon: '🕸️', ac: 15, hp: 24, speed: 6, xp: 450, gold: '6d10+40', size: 1, boss: true, finalBoss: true, dex: 15, vision: 8, mp: 30,
    ...
    },
    {
      ...
      map: {
        ...
        ascii: [
          ...
          '#.g...g..g.Sg.S.g...g..g...g...g..g....#',
          '#..g..g...g.SgS..g...g...g..g...g..g...#',
          '#.g...g..g..SS.g..g...g...g..g.....g.#',
