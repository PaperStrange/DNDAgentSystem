...
export const MONSTERS = {
  ...
  goblin: { key: 'goblin', name: '哥布林', icon: '👺', ac: 15, hp: 7, speed: 6, xp: 50, gold: '1d8+3', size: 1, dex: 14, vision: 8,
    attacks: [{ id: 'scimitar', name: '短弯刀', bonus: 4, dmg: '1d6+2', range: 1 }, { id: 'bow', name: '短弓', bonus: 4, dmg: '1d6+2', range: 12 }],
    desc: '绿皮小恶棍，成群结队，欺软怕硬。' },
  wolf: { key: 'wolf', name: '饿狼', icon: '🐺', ac: 13, hp: 11, speed: 7, xp: 50, gold: 0, size: 1, dex: 15, vision: 10,
  ...
  ruffian: { key: 'ruffian', name: '红标帮打手', icon: '🥷', ac: 14, hp: 16, speed: 6, xp: 100, gold: '1d10+5', size: 1, dex: 12, vision: 8,
  ...
  glasstaff: { key: 'glasstaff', name: '格拉斯塔夫', icon: '🧙‍♂️', ac: 12, hp: 22, speed: 6, xp: 300, gold: '3d10+15', size: 1, boss: true, dex: 14, vision: 8, mp: 20,
  ...
  hobgoblin: { key: 'hobgoblin', name: '霍布哥布林', icon: '🪖', ac: 18, hp: 11, speed: 6, xp: 100, gold: '1d10+8', size: 1, dex: 12, vision: 8,
    attacks: [{ id: 'longsword', name: '长剑', bonus: 3, dmg: '1d8+1', range: 1 }],
    desc: '纪律严明的哥布林近亲，身披鳞甲。' },
  bugbear: { key: 'bugbear', name: '熊地精', icon: '🐻', ac: 16, hp: 24, speed: 6, xp: 200, gold: '2d10+10', size: 1, dex: 14, vision: 8,
  ...
  doppelganger: { key: 'doppelganger', name: '变形怪', icon: '🎭', ac: 14, hp: 20, speed: 6, xp: 250, gold: '2d10+10', size: 1, dex: 18, vision: 8,
    attacks: [{ id: 'slam', name: '猛击', bonus: 5, dmg: '2d6+3', range: 1 }],
    desc: '能变作他人模样的诡诈生物，戈洛尔的座上宾。' },
  skeleton: { key: 'skeleton', name: '骷髅兵', icon: '💀', ac: 13, hp: 13, speed: 6, xp: 75, gold: 0, size: 1, undead: true, dex: 14, vision: 8,
    attacks: [{ id: 'sbow', name: '短弓', bonus: 4, dmg: '1d6+2', range: 10 }, { id: 'ssword', name: '短剑', bonus: 4, dmg: '1d6+2', range: 1 }],
    desc: '百年前矿难矿工的遗骸，仍守护着洞穴。' },
  zombie: { key: 'zombie', name: '僵尸', icon: '🧟', ac: 8, hp: 18, speed: 4, xp: 75, gold: 0, size: 1, undead: true, dex: 6, vision: 6,
    attacks: [{ id: 'slam', name: '猛击', bonus: 3, dmg: '1d6+1', range: 1 }],
    desc: '蹒跚的亡者，生命力顽强得诡异。' },
  giantspider: { key: 'giantspider', name: '巨蜘蛛', icon: '🕷️', ac: 14, hp: 20, speed: 6, xp: 200, gold: 0, size: 1, dex: 16, vision: 10,
